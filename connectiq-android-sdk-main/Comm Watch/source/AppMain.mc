...
class CommExample extends Application.AppBase {
    ...
    function handleRecordingStarted() {
        try {
            ...
            System.println("RECORDING START TIME SET TO: " + RecordingManager.recordingStartTime);
            ...
            System.println("Recording Started - Timer set to: " + RecordingManager.recordingStartTime);
    ...
    function handleRecordingStopped() {
        try {
            ...
            RecordingManager.wasRecordingActive = true; // Set this flag to indicate we just stopped recording
